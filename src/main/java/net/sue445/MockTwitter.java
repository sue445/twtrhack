...
public class MockTwitter implements Twitter {
	...
	@Override
	public ResponseList<Trends> getDailyTrends(Date date,
			boolean excludeHashTags) throws TwitterException {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
	...
	@Override
	public ResponseList<Trends> getWeeklyTrends(Date date,
			boolean excludeHashTags) throws TwitterException {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
	...
	@Override
	public ResponseList<Status> getRetweetedToUser(String screenName,
	...
	@Override
	public ResponseList<Status> getRetweetedByUser(String screenName,
			Paging paging) throws TwitterException {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
	...
	@Override
	public PagableResponseList<UserList> getUserLists(long listOwnerUserId,
			long cursor) throws TwitterException {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
	...
	@Override
	public ResponseList<Status> getUserListStatuses(long listOwnerId, int id,
			Paging paging) throws TwitterException {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
	...
	public User checkUserListSubscription(String listOwnerScreenName,
			int listId, long userId) throws TwitterException {
		// TODO 自動生成されたメソッド・スタブ
		return null;
	}
